<div class="container mx-auto p-4">
        ...
        <table class="w-full border-collapse" id="deudoresTable">
            <thead>
                <tr class="bg-gray-200 text-gray-700 sticky top-0 z-10">
                    <th class="p-2 font-normal text-md border-slate-300 border-r border-l"></th>
                    <th class="p-2 font-normal text-md border-slate-300 border-r border-l">RECURSO</th>
                    <th class="p-2 font-normal text-md border-slate-300 border-r border-l">IMPONIBLE</th>
                    <th class="p-2 font-normal text-md border-slate-300 border-r border-l">AÑO</th>
                    <th class="p-2 font-normal text-md border-slate-300 border-r border-l">CUOTA</th>
                    <th class="p-2 font-normal text-md border-slate-300 border-r border-l">MONTO TOTAL</th>
                    <th class="p-2 font-normal text-md border-slate-300 border-r border-l">FECHA VTO.</th>
                    <th class="p-2 font-normal text-md border-slate-300 border-r border-l">SITUACIÓN</th>
                    <th class="p-2 font-normal text-md border-slate-300 border-r border-l">NRO. PLAN</th>
                    <th class="p-2 font-normal text-md border-slate-300 border-r border-l">ID GESTIÓN</th>
    ...
    <div class="mt-4 flex justify-between items-center">
        @if ($hasMore)
            <span id="loadingMore" class="text-gray-500">Cargar mas</span>
        @else
